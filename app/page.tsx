      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          ...
          <Image
            ...
            alt="Screenshots of dashboard porject showing desktop version"
          />
          <Image
            src="/hero-mobile.png"
            width={560}
            ...
            alt="Screenshots of dashboard porject showing mobile version"
          />
        </div>
      </div>
    </main>
